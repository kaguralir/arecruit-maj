...
export default function choixContrat() {
    return (
        <div>
           <section>
                <div className="container py-5">
                    ...
                    <div className="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <h1 className="h6 text-uppercase font-weight-bold mb-4">Agility</h1>
                        <h2 className="h1 font-weight-bold"><span className="text-small font-weight-normal ml-2">/ month</span></h2>
